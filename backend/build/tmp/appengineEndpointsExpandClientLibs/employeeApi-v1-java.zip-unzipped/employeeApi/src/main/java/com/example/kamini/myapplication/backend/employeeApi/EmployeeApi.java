 ...
 * on 2016-03-04 at 12:54:09 UTC 
 * Modify at your own risk.
 */

package com.example.kamini.myapplication.backend.employeeApi;
...
public class EmployeeApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetEmployee extends EmployeeApiRequest<com.example.kamini.myapplication.backend.employeeApi.model.Employee> {
    ...
    protected GetEmployee(java.lang.Long id) {
      super(EmployeeApi.this, "GET", REST_PATH, null, com.example.kamini.myapplication.backend.employeeApi.model.Employee.class);
   ...
   *
   * @param content the {@link com.example.kamini.myapplication.backend.employeeApi.model.Employee}
   * @return the request
   */
  public InsertEmployee insertEmployee(com.example.kamini.myapplication.backend.employeeApi.model.Employee content) throws java.io.IOException {
    InsertEmployee result = new InsertEmployee(content);
    initialize(result);
    return result;
  }

  public class InsertEmployee extends EmployeeApiRequest<com.example.kamini.myapplication.backend.employeeApi.model.Employee> {
     ...
     * @since 1.13
     */
    protected InsertEmployee(com.example.kamini.myapplication.backend.employeeApi.model.Employee content) {
      super(EmployeeApi.this, "POST", REST_PATH, content, com.example.kamini.myapplication.backend.employeeApi.model.Employee.class);
    }
