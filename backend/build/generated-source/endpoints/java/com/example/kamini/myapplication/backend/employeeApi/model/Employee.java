...
package com.example.kamini.myapplication.backend.employeeApi.model;
...
public final class Employee extends com.google.api.client.json.GenericJson {
   ...
   */
  public Employee setDesignation(java.lang.String designation) {
   ...
   */
  public Employee setId(java.lang.Integer id) {
    this.id = id;
    return this;
  }
